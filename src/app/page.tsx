  ...
  return (
    <div id="top" className="min-h-screen bg-surface-muted text-text-primary">
      ...
      <section className="relative overflow-hidden">
        <div
          className="pointer-events-none absolute -left-32 top-20 h-72 w-72 rounded-full bg-brand-warm/30 blur-3xl"
          aria-hidden
        />
        <div
          className="pointer-events-none absolute -right-24 top-40 h-96 w-96 rounded-full bg-brand-blue/15 blur-3xl"
          aria-hidden
        />
        <div
          className="pointer-events-none absolute bottom-0 left-1/3 h-64 w-64 rounded-full bg-brand-accent/10 blur-3xl"
          aria-hidden
        />
        <div className="relative mx-auto grid max-w-6xl gap-12 px-4 py-16 md:grid-cols-2 md:items-center md:px-6 md:py-24">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-brand-accent">
              AI fashion · fit · wardrobe
            </p>
            <h1 className="mt-4 text-4xl font-bold leading-[1.1] tracking-tight md:text-5xl lg:text-[3.25rem]">
              Know your{" "}
              <span className="text-brand-blue">size story</span>
              <br />
              before you buy.
            </h1>
            <p className="mt-5 max-w-lg text-lg leading-relaxed text-text-muted">
              FitCheck turns links and photos into clear fit guidance, try-ons,
              and a stylist chat—bright, fast, and built for real closets.
            </p>
            ...
            <p className="mt-4 text-sm text-text-muted">
              7-day free trial · Full access to core features
            </p>
          </div>
          <div className="relative mx-auto w-full max-w-md md:max-w-none">
            <LandingHeroGraphic className="h-auto w-full drop-shadow-sm" />
          </div>
        </div>
      </section>
